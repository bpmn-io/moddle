 ...
 * @typedef {import('./moddle.js').PackageDef} PackageDef
 * @typedef {import('./moddle.js').TypeDef} TypeDef
 * @typedef {import('./moddle.js').PropertyDef} PropertyDef
 * @typedef {import('./properties.js').default} Properties
 * @typedef {import('./descriptor-builder.js').Descriptor} Descriptor
 */

/**
 * Registered package definition
 * @typedef {Omit<PackageDef, 'types'> & {
 ...
 * @typedef {Omit<TypeDef, 'properties'> & PackageLink & {
 ...
 * @typedef {PropertyDef & { ns: Namespace }} RegisteredPropertyDef
 */

/**
 * Effective element type descriptor
 * @typedef {Descriptor & PackageLink} EffectiveDescriptor
 */

/**
 * A registry of Moddle packages.
 *
 * @param {Array<PackageDef>} packages
...
/**
 * @param {PackageDef} pkg registering package
 */
...
/**
 * @param {RegisteredTypeDef} target
 * @param {RegisteredPackage} pkg
 */
