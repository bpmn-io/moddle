 ...
 * @typedef {import('./moddle').PackageDef} PackageDef
 * @typedef {import('./moddle').TypeDef} TypeDef
 * @typedef {import('./moddle').PropertyDef} PropertyDef
 * @typedef {import('./properties').default} Properties
 * @typedef {import('./descriptor-builder').Descriptor} Descriptor
 */
