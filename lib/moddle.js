 ...
 * @typedef {import('./registry').RegisteredPackage} RegisteredPackage
 * @typedef {import('./descriptor-builder').PropertyDesc} PropertyDesc
 * @typedef {import('./base').default} BaseElement
 */

/**
 * @template [T=Record<string,any>]
 * @typedef {import('./factory').ModdleElement<T>} ModdleElement
 * @typedef {import('./factory').ModdleElementType<T>} ModdleElementType
 * @typedef {import('./factory').AnyModdleElement<T>} AnyModdleElement
 */
