...
BaseType.prototype.__instanceOf = isA;
...
function Model(packages, options) {
   ...
   * });
   * 
   * var container = moddle.create('my:Container', {
   *   any: [ foo ]
   * });
   *
   ...
   * @param  {[type]} nsUri [description]
   * @param  {[type]} attrs [description]
   * @return {[type]}       [description]
   */
  function createAny(name, nsUri, attrs) {
    ...
    _.forEach(attrs, function(a, key) {
